...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = findViewById(R.id.lvExp1);
    ...
    private void showData(DataSnapshot dataSnapshot, String msg) {
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            if(ds.getValue(Exams.class).getStd().contains(msg)) {
                ...
                if(ds.getValue(Exams.class).getTags().contains("exam")) {
                    array.add(sInfo);
        ...
        mListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Intent i=new Intent(Main3Activity.this,ScrollingActivity.class);
    ...
    private void prepareListData(ArrayList zeroX,ArrayList oneX) {
